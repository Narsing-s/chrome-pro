...
contextBridge.exposeInMainWorld('chromePro', {
  ...
  open: u => ipcRenderer.invoke('browser:open', u), navigate: u => ipcRenderer.invoke('browser:navigate', u),
  ...
  back: () => ipcRenderer.invoke('browser:back'), forward: () => ipcRenderer.invoke('browser:forward'), reload: () => ipcRenderer.invoke('browser:reload'),
  ...
  removeBookmark: u => ipcRenderer.invoke('browser:remove-bookmark', u), downloads: () => ipcRenderer.invoke('browser:downloads'), clearSiteData: () => ipcRenderer.invoke('browser:clear-data'), openExternal: u => ipcRenderer.invoke('browser:external', u),
